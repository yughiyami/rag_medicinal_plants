...
La Tabla~\ref{tab:baselines} muestra c\'{o}mo queda \sirca{} frente al sistema m\'{a}s pr\'{o}ximo publicado bajo el mismo marco RAGAs para texto biom\'{e}dico y normativo en espa\~{n}ol. La mejora en Context Recall (Cobertura de Contexto) es de $18{,}0\%$ en t\'{e}rminos relativos ($7{,}5$ puntos porcentuales absolutos: $0{,}492$ frente a $0{,}417$) por encima de Collanqui et al.~\cite{collanqui2026cagrag}; conviene precisar que esta comparaci\'{o}n cuantitativa aplica \'{u}nicamente a Context Recall, pues dicho antecedente no reporta MRR ni Fidelidad (celdas ``---'' en la Tabla~\ref{tab:baselines}). El MRR de $0{,}837$ indica que, en la gran mayor\'{i}a de las consultas, el documento m\'{a}s relevante queda en la primera o segunda posici\'{o}n del ranking.
...
\textbf{\sirca{} (nuestro)} & DeepSeek V4-Flash & \textbf{0{,}492} & \textbf{0{,}837} & \textbf{0{,}566} \\
\bottomrule
\end{tabular}
\end{table}
